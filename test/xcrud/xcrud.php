...
class Xcrud
{
    ...
    protected $show_primary_ai_column = true;
    protected $url;
    protected $key;
    ...
    public static function get_requested_instance()
    {
            ...
            $key)
        {
            ...
            self::error('<strong>La Clave de Verificación Está Desactualizada</strong><br />
                ...
                ¿Por qué? Tal vez presionó el botón Atrás en su navegador o abrió un marcador de la sesión anterior <br /><strong>Solo recargue la página, no pasa nada... :)</strong>');
    }
    ...
    public static function load_js()
    {
        ...
        $out .= '<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCn_Rb5rYuyJ1GyI3diJmJsXPles7Eqcsw"
